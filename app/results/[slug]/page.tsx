...
export default async function ResultsPage({
  ...
  const [{ data: scoreRow }, { data: reflectionRow }] = await Promise.all([
    supabase
  ...
  return (
    <main className="results-shell">
      ...
      <section className="results-section closing-question" aria-labelledby="closing-heading">
        ...
        <h2 id="closing-heading">What are you still asking money to make true before you allow yourself to feel differently?</h2>
      </section>
      ...
      <footer className="results-footer">
        ...
        <p>Scoring {scoreRow.scoring_version} · Questions {scoreRow.question_version}</p>
      </footer>
    </main>
  );
}
